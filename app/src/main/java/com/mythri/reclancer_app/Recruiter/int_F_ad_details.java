...
public class int_F_ad_details extends Activity {

    TextView p_skill,exps,s_skill,jtitle,mail,phone,padd,pper,sd,ed,d,nam;
    String user_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freed_details);
        ...
        if (post_dict.length() > 0) {
            new int_F_ad_details.SendJsonDataToServer().execute(String.valueOf(post_dict));
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://reclancer.com/app_F_ad_details.php");
