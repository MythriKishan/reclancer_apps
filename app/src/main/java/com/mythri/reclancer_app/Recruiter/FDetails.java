...
public class FDetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (post_dict.length() > 0) {
            new FDetails.SendJsonDataToServer().execute(String.valueOf(post_dict));
    ...
    public void interested(View view) {
        ...
        if (post_dict.length() > 0) {
            new FDetails.SendData().execute(String.valueOf(post_dict));
    ...
    class SendData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://reclancer.com/app_apply_freelancer.php");
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            BufferedReader reader = null;
            try {
                URL url = new URL("https://reclancer.com/appfreead_details.php");
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setDoOutput(true);
                // is output buffer writter
                urlConnection.setRequestMethod("POST");
