...
public class R_Reset_Pass extends AppCompatActivity {
    ...
    public void resetpass(View view) {
        ...
        if (post_dict.length() > 0) {
            new R_Reset_Pass.SendDataToServer().execute(String.valueOf(post_dict));
    ...
    class SendDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://reclancer.com/appreset_recpass.php");
