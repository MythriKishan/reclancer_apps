...
public class Rfailure extends AppCompatActivity {

    private APIRLogout lAPIService;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rfailure);
    }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.home:
                        Intent home = new Intent(Rfailure.this, RHome.class);
                        home.putExtra("Id",Id);
                        startActivity(home);
                        return true;

                    case R.id.postad:
                        Intent post = new Intent(Rfailure.this, RPostAd.class);
                        post.putExtra("Id",Id);
                    ...
                    case R.id.mjobs:
                        Intent manage = new Intent(Rfailure.this, ManageRJobs.class);
                    ...
                    case R.id.recsetting:
                        Intent pset = new Intent(Rfailure.this, R_PSettings.class);
                        pset.putExtra("Id",Id);
                        startActivity(pset);
                        return true;

                    case R.id.fsearch:
                        Intent search = new Intent(Rfailure.this, RSearch.class);
    ...
    private void goToLogInActivity() {
        ...
        Intent intent = new Intent(Rfailure.this, RLogin.class);
        finish();
