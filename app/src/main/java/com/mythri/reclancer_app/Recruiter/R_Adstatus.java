...
import com.mythri.reclancer_app.Network.APIRAdStatus;
...
public class R_Adstatus extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private APIRAdStatus mAPIService;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rstatus);
        ...
        if (post_dict.length() > 0) {
            new R_Adstatus.SendDataToServer().execute(String.valueOf(post_dict));
    ...
    class SendDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://reclancer.com/appRad_status.php");
    ...
    private void displayData(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonarray.length(); i++) {
            ...
            Button btn = (Button) findViewById(R.id.change_rstatus);

            mAPIService = ApiUtil.getAPIR_adstatus();
    ...
    public void R_statusupdate(String ad_id, String st){
        mAPIService.R_statusupdate(ad_id, st).enqueue(new Callback<RecAdStatus>() {
            @Override
            public void onResponse(Call<RecAdStatus> call, Response<RecAdStatus> response) {

                if (response.isSuccessful()) {
                    //showResponse(response.body().toString());
                    //Log.i(TAG, "post submitted to API." + response.body().toString());
                    Toast t = Toast.makeText(getApplicationContext(), "Changed Status Successfully", Toast.LENGTH_SHORT);
                    t.show();
                    ...
                    tst.show();
                    Intent su = new Intent(R_Adstatus.this, ManageRJobs.class);
                    su.putExtra("Id",Id);
                    startActivity(su);
                }
            }
            ...
            @Override
            public void onFailure(Call<RecAdStatus> call, Throwable t) {
