...
public class  ViewRdetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewrdetails);
        ...
        if (post_dict.length() > 0) {
            new ViewRdetails.SendJsonDataToServer().execute(String.valueOf(post_dict));
    ...
    public void interested(View view) {
        ...
        if (post_dict.length() > 0) {
            new ViewRdetails.SendData().execute(String.valueOf(post_dict));
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            BufferedReader reader = null;
            try {
                URL url = new URL("https://reclancer.com/apprec_viewad.php");
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setDoOutput(true);
                // is output buffer writter
                urlConnection.setRequestMethod("POST");
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.fhome:
                        Intent home = new Intent(ViewRdetails.this, RHome.class);
                        home.putExtra("Id",Id);
                        startActivity(home);
                        return true;

                    case R.id.postad:
                        Intent post = new Intent(ViewRdetails.this, RPostAd.class);
                        post.putExtra("Id",Id);
                    ...
                    case R.id.mfjobs:
                        Intent manage = new Intent(ViewRdetails.this, ManageRJobs.class);
                    ...
                    case R.id.psettings:
                        Intent pset = new Intent(ViewRdetails.this, R_PSettings.class);
                        pset.putExtra("Id",Id);
                        startActivity(pset);
                        return true;

                    case R.id.rsearch:
                        Intent search = new Intent(ViewRdetails.this, FSearch.class);
    ...
    private void goToLogInActivity() {
        ...
        Intent intent = new Intent(ViewRdetails.this, RLogin.class);
        finish();
