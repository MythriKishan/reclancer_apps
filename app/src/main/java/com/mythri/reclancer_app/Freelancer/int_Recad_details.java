...
public class int_Recad_details extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rad_details);
        ...
        if (post_dict.length() > 0) {
            new int_Recad_details.SendJsonDataToServer().execute(String.valueOf(post_dict));
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://reclancer.com/apprec_ad_details.php");
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.fhome:
                        Intent home = new Intent(int_Recad_details.this, FHome.class);
                        home.putExtra("Id",Id);
                        startActivity(home);
                        return true;

                    case R.id.postad:
                        Intent post = new Intent(int_Recad_details.this, FPostAd.class);
                        post.putExtra("Id",Id);
                    ...
                    case R.id.mfjobs:
                        Intent manage = new Intent(int_Recad_details.this, ManageFJobs.class);
                    ...
                    case R.id.psettings:
                        Intent pset = new Intent(int_Recad_details.this, F_PSettigs.class);
                        pset.putExtra("Id",Id);
                        startActivity(pset);
                        return true;

                    case R.id.rsearch:
                        Intent search = new Intent(int_Recad_details.this, RSearch.class);
    ...
    private void goToLogInActivity() {
        ...
        Intent intent = new Intent(int_Recad_details.this, FLogin.class);
        finish();
