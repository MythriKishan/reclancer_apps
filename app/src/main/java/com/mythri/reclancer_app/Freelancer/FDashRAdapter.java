...
public class FDashRAdapter extends RecyclerView.Adapter<FDashRAdapter.ViewHolderFJobs> {

    // declaring variables
    private Context context;
    private List<F_RDashAds> results;

    //constructor
    FDashRAdapter(Context context, List<F_RDashAds> R_Jobs) {
        this.context = context;
        this.results = R_Jobs;
    }

    @Override
    public FDashRAdapter.ViewHolderFJobs onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FDashRAdapter.ViewHolderFJobs viewholder = new FDashRAdapter.ViewHolderFJobs(view);

        return viewholder;
    }

    @Override
    public void onBindViewHolder(final FDashRAdapter.ViewHolderFJobs holder, int position) {
        ...
        holder.ad_details.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent sad = new Intent(v.getContext(), int_Recad_details.class);
